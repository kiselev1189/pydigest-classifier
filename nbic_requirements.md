...
где `link1...linkN` - это строки, а второй элемент списка это булево значение True или False - результат классификации (True - ссылка хорошая, False - плохая)
